...
# @raycast.title Phase · Build
# @raycast.mode silent
# @raycast.icon 🛠️
# @raycast.packageName DOS · Stream
# @raycast.description Set Terminal Frame phase rail to BUILD
...
"$BUN" "${DOTFILES_DIR:-$HOME/dotfiles}/scripts/scripts/dos-stream.ts" phase build
