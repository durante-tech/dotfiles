...
# @raycast.title Phase · Plan
# @raycast.mode silent
# @raycast.icon 📋
# @raycast.packageName DOS · Stream
# @raycast.description Set Terminal Frame phase rail to PLAN
...
"$BUN" "${DOTFILES_DIR:-$HOME/dotfiles}/scripts/scripts/dos-stream.ts" phase plan
