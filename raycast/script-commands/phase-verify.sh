...
# @raycast.title Phase · Verify
# @raycast.mode silent
# @raycast.icon ✅
# @raycast.packageName DOS · Stream
# @raycast.description Set Terminal Frame phase rail to VERIFY
...
"$BUN" "${DOTFILES_DIR:-$HOME/dotfiles}/scripts/scripts/dos-stream.ts" phase verify
