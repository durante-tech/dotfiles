...
description: "How to fork this dotfiles repo and make it your own."
---
...
See [personalization](/personalize/) for validation, previews, and undo.
...
<CompleteLessonButton client:idle lessonId="7.6" slug="getting-started/customizing" />
