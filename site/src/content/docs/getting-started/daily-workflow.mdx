...
description: "Quick reference for your daily development workflow with all the tools configured."
---
...
<CompleteLessonButton client:idle lessonId="5.6" slug="getting-started/daily-workflow" nextLessonSlug="yazi" nextLessonTitle="Yazi File Manager" />
