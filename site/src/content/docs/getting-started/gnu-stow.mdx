---
title: "GNU Stow Guide"
description: "How this dotfiles system deploys configurations using symlinks."
---
...
**Next:** [Quick Start](/getting-started/quick-start/) — start using the system

<CompleteLessonButton client:idle lessonId="0.3" slug="getting-started/gnu-stow" nextLessonSlug="getting-started/quick-start" nextLessonTitle="Quick Start" />
