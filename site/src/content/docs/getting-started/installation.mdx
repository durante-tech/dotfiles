...
description: "From a fresh macOS to a fully working system, step by step."
---
...
Each package directory mirrors `$HOME` structure. Stow creates symlinks so configs appear in the right place. See [GNU Stow Guide](/getting-started/gnu-stow/) for details.
...
**Dotfiles · Preferences**. Follow [Personalization](/personalize/) for
...
**Next:** [GNU Stow Guide](/getting-started/gnu-stow/) — understand how configs are deployed

{/* reference:end */}

<CompleteLessonButton client:idle lessonId="0.2" slug="getting-started/installation" nextLessonSlug="getting-started/gnu-stow" nextLessonTitle="GNU Stow" />
