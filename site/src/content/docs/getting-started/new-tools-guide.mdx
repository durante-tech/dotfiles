---
title: "New Tools Guide"
description: "Quick reference for the CLI tools added to your dotfiles setup."
---
...
<CompleteLessonButton client:idle lessonId="6.2" slug="getting-started/new-tools-guide" nextLessonSlug="zsh/aliases-and-functions" nextLessonTitle="Aliases & Functions" />
