...
description: "GPU-accelerated terminal emulator with tmux-style keybindings."
---
...
<CompleteLessonButton client:idle lessonId="1.4" slug="ghostty" nextLessonSlug="neovim/workflows/navigation" nextLessonTitle="Navigation Workflows" />
