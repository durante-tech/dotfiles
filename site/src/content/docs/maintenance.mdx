---
title: "Maintenance command contract"
description: "Run these from a cloned checkout. The installer requires its shipped lib/"
---
...
[display controls](/display/) and [luminance calibration](/display/luminance/).
