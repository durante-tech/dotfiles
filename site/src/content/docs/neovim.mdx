...
description: "This Neovim configuration is built for modern development workflows with Lazy.nvim, LSP, and keyboard-driven productivity."
---
...
### Getting Started
- **[Keybindings](/neovim/keybindings/)** - Complete keybinding reference
- **[Daily Cheatsheet](/neovim/daily-cheatsheet/)** - Most common operations

### Workflows
- **[Editing](/neovim/workflows/editing/)** - Writing and manipulating code
- **[Navigation](/neovim/workflows/navigation/)** - Moving through files and code
- **[File Management](/neovim/workflows/file-management/)** - Finding and managing files
- **[Search & Replace](/neovim/workflows/search-replace/)** - Finding and transforming text
- **[Copy/Paste/Move](/neovim/workflows/copy-paste-move/)** - Clipboard and text manipulation
- **[Windows & Buffers](/neovim/workflows/windows-buffers/)** - Splits, buffers, and tabs
- **[LSP & Completion](/neovim/workflows/lsp/)** - Language server features

### Configuration
- **[Formatters](/neovim/formatters/)** - Code formatting setup (Conform.nvim)
- **[Formatter Troubleshooting](/neovim/formatter-troubleshooting/)** - Fixing formatter issues

### Reference
- **[Tips & Tricks](/neovim/tips-and-tricks/)** - Power user techniques
- **[Troubleshooting](/neovim/troubleshooting/)** - Common issues and solutions
