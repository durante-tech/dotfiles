---
title: "Formatter Configuration Guide"
description: "Project-owned formatter selection, synchronous saves, and diagnostics in Neovim."
---
...
See [formatter troubleshooting](/neovim/formatter-troubleshooting/) and the
[maintenance command contracts](/maintenance/). Prettier documents its
...
<CompleteLessonButton client:idle lessonId="7.5" slug="neovim/formatters" nextLessonSlug="getting-started/customizing" nextLessonTitle="Customizing" />
