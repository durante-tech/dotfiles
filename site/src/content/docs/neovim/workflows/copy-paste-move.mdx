---
title: "Copy, Paste & Move Workflows"
description: "Master efficient text manipulation - copying, pasting, and moving content within and between files."
---
...
**Next:** [Window & Buffer Management](/neovim/workflows/windows-buffers/)

<CompleteLessonButton client:idle lessonId="3.2" slug="neovim/workflows/copy-paste-move" nextLessonSlug="neovim/workflows/search-replace" nextLessonTitle="Search & Replace" />
