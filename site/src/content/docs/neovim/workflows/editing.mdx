...
description: "Master efficient code editing with Neovim's powerful modal editing system."
---
...
**Next:** [Navigation Workflows](/neovim/workflows/navigation/) to move efficiently through your code.

---

## Practice

<KeybindingTrainer client:idle drillSet={neovimEditing} maxQuestions={5} />

<CompleteLessonButton client:idle lessonId="3.1" slug="neovim/workflows/editing" nextLessonSlug="neovim/workflows/copy-paste-move" nextLessonTitle="Copy, Paste, Move" />
