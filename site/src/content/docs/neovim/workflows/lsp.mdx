---
title: "LSP & Completion Workflows"
description: "Master intelligent code features powered by Language Server Protocol."
---
...
import drills from '../../../../data/keybindings/neovim-navigation.json';
...
See [LSP Configuration](/neovim/workflows/lsp/) for details.
...
**Next:** [Search & Replace Workflows](/neovim/workflows/search-replace/)
...
<CompleteLessonButton client:idle lessonId="4.1" slug="neovim/workflows/lsp" nextLessonSlug="neovim/keybindings" nextLessonTitle="Keybinding Reference" />
