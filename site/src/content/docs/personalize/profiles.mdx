---
title: "Explicit preference profiles"
description: "Profiles save a named selection of supported preferences. You choose their values"
---
...
the reload guidance printed by the personalizer. See [personalization](/personalize/)
