---
title: "rmpc - Music Player Client"
description: "rmpc is a Rust-based TUI client for MPD (Music Player Daemon). It provides a vim-style interface for managing your music library."
---
...
**Requires**: MPD running (`mpd` command). See [MPD docs](/mpd/).
