...
description: "Utility scripts automatically available in PATH via ~/scripts/."
---
...
<CompleteLessonButton client:idle lessonId="6.5" slug="scripts" nextLessonSlug="tmux/keybindings" nextLessonTitle="Tmux Keybindings" />
