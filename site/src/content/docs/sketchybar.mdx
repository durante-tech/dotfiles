...
description: "Custom macOS status bar with system monitoring and AeroSpace integration."
---
...
<CompleteLessonButton client:idle lessonId="5.3" slug="sketchybar" nextLessonSlug="starship" nextLessonTitle="Starship Prompt" />
