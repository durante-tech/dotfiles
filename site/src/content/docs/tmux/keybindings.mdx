---
title: "Tmux Keybindings Reference"
description: "Complete keyboard shortcut reference for your tmux configuration."
---
...
**Next:** [Tmux-Nvim Integration](/tmux/integration/nvim/) - Seamless workflow between tmux and Neovim

<CompleteLessonButton client:idle lessonId="6.6" slug="tmux/keybindings" nextLessonSlug="mpd" nextLessonTitle="MPD Music" />
