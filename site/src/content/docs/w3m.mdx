---
title: "w3m - Terminal Web Browser"
description: "w3m is a text-mode web browser integrated into the tmux workflow. Access it via Ctrl+Space > Ctrl+W as a floating tmux popup."
---
...
<CompleteLessonButton client:idle lessonId="6.8" slug="w3m" nextLessonSlug="integration/development-stack" nextLessonTitle="Development Stack" />
