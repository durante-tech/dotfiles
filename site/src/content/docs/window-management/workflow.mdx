...
description: "How to use AeroSpace and Karabiner together for full keyboard-driven window management on macOS."
---
...
**Next:** [Daily Workflow](/getting-started/daily-workflow/)

<CompleteLessonButton client:idle lessonId="5.5" slug="window-management/workflow" nextLessonSlug="getting-started/daily-workflow" nextLessonTitle="Daily Workflow" />
