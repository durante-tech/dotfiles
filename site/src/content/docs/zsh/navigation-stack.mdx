---
title: "Shell Navigation Stack"
description: "How FZF, Zoxide, and Atuin work together to make shell navigation instant."
---
...
**Next:** [Git Workflow](/git/workflow/)

---

## Practice

<KeybindingTrainer client:idle drillSet={zshCore} maxQuestions={5} />

<CompleteLessonButton client:idle lessonId="2.5" slug="zsh/navigation-stack" nextLessonSlug="neovim/workflows/editing" nextLessonTitle="Editing Workflows" />
